let sample_data = [
    ...
    {
        Brand:"Puma",
        img_src:"https://rukminim2.flixcart.com/image/612/612/l0y6qa80/kids-lehenga-choli/v/l/u/4-5-years-gajra-the-fashion-prime-original-imagcmgezfqsknry.jpeg?q=70",
        names:"Men Slim Fit Self",
        price:"$558",
        actualprice:"$1,399"
    },
...
function Product(){
    collection.map((element)=>{
        ...
        p2.innerHTML = "Actual Price : "
        price2.innerHTML = element.actualprice

        innerbox.append(p1,price1,p2,price2);
